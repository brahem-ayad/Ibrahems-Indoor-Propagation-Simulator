...
int main() {
  ...
  walls.push_back( Wall({100, 100}, {1500, 100}) );
  walls.push_back( Wall({1500, 100}, {1500, 800}) );
  walls.push_back( Wall({1500, 800}, {100, 800}) );
  walls.push_back( Wall({100, 800}, {100, 100}) );
  walls.push_back( Wall({800, 445}, {1500, 445}) );
  walls.push_back( Wall({800, 455}, {1500, 455}) );
  walls.push_back( Wall({800, 445}, {800, 455}) );

  InitWindow(1600, 900, "Indoor Propagation Simulator");
  ToggleFullscreen();
  SetTargetFPS(60);
