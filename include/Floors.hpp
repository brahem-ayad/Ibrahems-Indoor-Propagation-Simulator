...
class Floor {
  public:
    ...
    Floor(Vector2 P1, Vector2 P2, Vector2 P3, Vector2 P4) : P1(P1), P2(P2), P3(P3), P4(P4) {
      P13 = { P1.x / CONF::Grid_Spacing, -P1.y / CONF::Grid_Spacing, 0 };
      P23 = { P2.x / CONF::Grid_Spacing, -P2.y / CONF::Grid_Spacing, 0 };
      P33 = { P3.x / CONF::Grid_Spacing, -P3.y / CONF::Grid_Spacing, 0 };
      P43 = { P4.x / CONF::Grid_Spacing, -P4.y / CONF::Grid_Spacing, 0 };
