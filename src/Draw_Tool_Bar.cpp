...
void Draw_Tool_Bar(){
  ...
  if(GetMousePosition().x < 138 and GetScreenHeight() < 584 + 10 ){
    CONF::Tools_Bar_Scroll += GetMouseWheelMove() * 20;
  }
  if(CONF::Tools_Bar_Scroll < GetScreenHeight() - 584 - 50) CONF::Tools_Bar_Scroll =  GetScreenHeight() - 584 - 50;
  if(CONF::Tools_Bar_Scroll > 0) CONF::Tools_Bar_Scroll = 0;

  // the bacground
  DrawRectangleRoundedLinesEx({10, 22 + 10 + 2 + CONF::Tools_Bar_Scroll, 128, 584}, 0.3, 15, 2.0f, {128, 128, 128, 255});
  DrawRectangleRounded({10, 22 + 10 + CONF::Tools_Bar_Scroll, 128, 584}, 0.3, 15, {229, 229, 229, 200});
  DrawRectangleRoundedLinesEx({10, 22 + 10 + CONF::Tools_Bar_Scroll, 128, 584}, 0.3, 15, 2.0f, {128, 128, 128, 255});
  ...
  DrawTexture(CONF::Transmitters_Tool_Icon, 10+14, 22 + 10 + 14 + 3*(100 + 14) + CONF::Tools_Bar_Scroll, WHITE);
  DrawTexture(CONF::Receivers_Tool_Icon, 10+14, 22 + 10 + 14 + 4*(100 + 14) + CONF::Tools_Bar_Scroll, WHITE);
